...
let audioelement1 = new Audio("media/Sakhiyaan.mp3");
...
let audioelement2 = new Audio("media/Khaab.mp3");
...
let audioelement3 = new Audio("media/Yaariyan.mp3");
...
let audioelement4 = new Audio("media/Brown Munde.mp3");
...
let audioelement5 = new Audio("media/Teeji Seat.mp3");
